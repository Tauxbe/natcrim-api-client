...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.ProfileDefinitionGet();
  });
  ...
  describe('ProfileDefinitionGet', function() {
    it('should create an instance of ProfileDefinitionGet', function() {
      // uncomment below and update the code to test ProfileDefinitionGet
      //var instance = new NatcrimApiClient.ProfileDefinitionGet();
      //expect(instance).to.be.a(NatcrimApiClient.ProfileDefinitionGet);
    });
