...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.ProfileDefinition();
  });
  ...
  describe('ProfileDefinition', function() {
    it('should create an instance of ProfileDefinition', function() {
      // uncomment below and update the code to test ProfileDefinition
      //var instance = new NatcrimApiClient.ProfileDefinition();
      //expect(instance).to.be.a(NatcrimApiClient.ProfileDefinition);
    });
