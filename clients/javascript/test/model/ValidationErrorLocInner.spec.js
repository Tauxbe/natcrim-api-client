...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new NatcrimApiClient.ValidationErrorLocInner();
      //expect(instance).to.be.a(NatcrimApiClient.ValidationErrorLocInner);
    });
