...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new NatcrimApiClient.HTTPValidationError();
      //expect(instance).to.be.a(NatcrimApiClient.HTTPValidationError);
    });
