...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.ProfilePut();
  });
  ...
  describe('ProfilePut', function() {
    it('should create an instance of ProfilePut', function() {
      // uncomment below and update the code to test ProfilePut
      //var instance = new NatcrimApiClient.ProfilePut();
      //expect(instance).to.be.a(NatcrimApiClient.ProfilePut);
    });
