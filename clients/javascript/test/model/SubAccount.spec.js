...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.SubAccount();
  });
  ...
  describe('SubAccount', function() {
    it('should create an instance of SubAccount', function() {
      ...
      //var instance = new NatcrimApiClient.SubAccount();
      //expect(instance).to.be.a(NatcrimApiClient.SubAccount);
    });
    ...
    it('should have the property defaultProfile (base name: "default_profile")', function() {
