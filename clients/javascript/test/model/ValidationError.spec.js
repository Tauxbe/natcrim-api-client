...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new NatcrimApiClient.ValidationError();
      //expect(instance).to.be.a(NatcrimApiClient.ValidationError);
    });
