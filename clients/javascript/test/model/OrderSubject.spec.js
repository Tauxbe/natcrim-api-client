...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NatcrimApiClient.OrderSubject();
  });
  ...
  describe('OrderSubject', function() {
    it('should create an instance of OrderSubject', function() {
      // uncomment below and update the code to test OrderSubject
      //var instance = new NatcrimApiClient.OrderSubject();
      //expect(instance).to.be.a(NatcrimApiClient.OrderSubject);
    });
