...
class OrderPostResponseOutput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "sub_account_id", "result", "content"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "result": OrderResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,
            "content": AnyOf.from_dict(obj.get("content")) if obj.get("content") is not None else None
        })
        return _obj
