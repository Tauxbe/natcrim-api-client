...
public class Customer {
  ...
  **/
  ...
  public Customer adminEmail(String adminEmail) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, customer.id) &&
        ...
        Objects.equals(this.adminEmail, customer.adminEmail) &&
        Objects.equals(this.isDeleted, customer.isDeleted);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, adminEmail, isDeleted);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("admin_email");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("admin_email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `admin_email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("admin_email").toString()));
      }
  }
