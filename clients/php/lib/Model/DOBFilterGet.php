...
/**
 * DOBFilterGet Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DOBFilterGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DOBFilterGet';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['minimum_components_matched']) && ($this->container['minimum_components_matched'] < 0)) {
            $invalidProperties[] = "invalid value for 'minimum_components_matched', must be bigger than or equal to 0.";
        }
     ...
     *
     * @param bool|null $allow_off_by_one allow_off_by_one
     *
     * @return self
     */
     ...
     *
     * @param bool|null $allow_empty_dob allow_empty_dob
     *
     * @return self
     */
     ...
     *
     * @param int|null $minimum_components_matched minimum_components_matched
     *
     * @return self
     */
    public function setMinimumComponentsMatched($minimum_components_matched)
    {
        ...
        if (($minimum_components_matched > 3)) {
            throw new \InvalidArgumentException('invalid value for $minimum_components_matched when calling DOBFilterGet., must be smaller than or equal to 3.');
        }
        if (($minimum_components_matched < 0)) {
            throw new \InvalidArgumentException('invalid value for $minimum_components_matched when calling DOBFilterGet., must be bigger than or equal to 0.');
        }
