...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string $name Descriptive name of customer, such as their corporate entity name.
     *
     * @return self
     */
     ...
     * Sets admin_email
     *
     * @param string $admin_email Administrator's email address. Also functions as a username.
     *
     * @return self
     */
