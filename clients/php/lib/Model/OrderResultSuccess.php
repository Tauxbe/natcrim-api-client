...
/**
 * OrderResultSuccess Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderResultSuccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderResult_success';
    ...
    protected static $setters = [
        'records_returned' => 'setRecordsReturned'
    ];
    ...
    protected static $getters = [
        'records_returned' => 'getRecordsReturned'
    ];
    ...
    {
        $this->setIfExists('records_returned', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['records_returned'] === null) {
            $invalidProperties[] = "'records_returned' can't be null";
        }
    ...
    {
        return $this->container['records_returned'];
    }
