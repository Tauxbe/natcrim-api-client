...
class Me implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sub_account' => '\OpenAPI\Client\Model\SubAccount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sub_account', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets sub_account
     *
     * @return \OpenAPI\Client\Model\SubAccount
     */
     ...
     * Sets sub_account
     *
     * @param \OpenAPI\Client\Model\SubAccount $sub_account sub_account
     *
     * @return self
     */
    public function setSubAccount($sub_account)
    {
        if (is_null($sub_account)) {
            array_push($this->openAPINullablesSetToNull, 'sub_account');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sub_account', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
